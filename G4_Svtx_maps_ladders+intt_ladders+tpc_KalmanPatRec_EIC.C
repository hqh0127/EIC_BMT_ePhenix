...
//    mvtx->set_double_param(ilyr, "phi0", 0);
  ...
  double BMT_r[4] = {BMT_outer_radius-(nCZlayer*thickness+gap_betweenCZ)*4-3*Gap_betweenlayer, BMT_outer_radius-(nCZlayer*thickness+gap_betweenCZ)*3-2*Gap_betweenlayer, BMT_outer_radius-(nCZlayer*thickness+gap_betweenCZ)*2-Gap_betweenlayer, BMT_outer_radius-nCZlayer*thickness-gap_betweenCZ};
